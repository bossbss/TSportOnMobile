...
public class asyCallServiceAPIRestFulProcessDHLtracking extends AsyncTask<Void, Void, JSONObject> {
    ...
    public asyCallServiceAPIRestFulProcessDHLtracking(Context Context, AsyncTaskCompleteListener<JSONObject> cb, HashMap<String, String> ParamiterValues) {
    ...
    protected JSONObject doInBackground(Void... params) {
        ...
        try {
            ...
            String uri = SettingActivity.URLTRACKING;
            String body = "{\n" +
                    "    \"trackItemRequest\": {\n" +
                    "        \"hdr\": {\n" +
                    ...
                    "               \""+ParamiterValuse.get("tracking_code")+"\"\n" +
                    "            ]\n" +
                    "        }\n" +
                    "    }\n" +
                    "}";
